...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if ((url != null) && (url.length() > 10)) {
            try {
                mPicasso.load(url).into(holder.avatar);
            } catch (Exception e) {
                Log.d("MMV", e.getMessage());
                //    mPicasso.load(R.drawable.def_av).into(holder.avatar);
            }
        }
        return convertView;
    }
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (isMe) {
            ...
            holder.avatar.getLayoutParams().height = 1;
            holder.avatar.getLayoutParams().width = 1;
    ...
    private ViewHolder createViewHolder(View v) {
        ...
        holder.avatar = (RoundedImageView) v.findViewById(R.id.imageViewAvatar);
        return holder;
    }
