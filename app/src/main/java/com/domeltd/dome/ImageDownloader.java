...
/*--- we need to pass some objects we are going to work with ---*/
    ...
    /*--- we need this interface for keeping the reference to our Bitmap from the DomeSupportActivity.
     *  Otherwise, bmp would be null in our DomeSupportActivity*/
